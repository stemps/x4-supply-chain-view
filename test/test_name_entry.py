...
rows[2][1].handlers.onEditBoxDeactivated(nil, '  Renamed  ', true)
...
menu.displayNameEntry(frame, 5, 20, 800)
rows[2][1].handlers.onEditBoxDeactivated(nil, '   ', true)
rows[2][2].handlers.onClick()
assert(menu.mode == 'name' and SCV_Store.get(1).name == 'Renamed')
rows[2][1].handlers.onEditBoxDeactivated(nil, 'Cancelled', true)
