...
assert(string.find(a.rows[energyRow+3][1].props.mouseOverText, "Scrap processing: 3.0k/h", 1, true))
assert(string.find(a.rows[energyRow+3][1].props.mouseOverText, "Recycling and other production: 600/h", 1, true))
